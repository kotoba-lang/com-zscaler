(ns ake.cells.social-post.state-machine
  "Phase state machine for the 朱 — Community-Edit Membrane (Wikipedia-stance) social_post cell — the publication membrane that
