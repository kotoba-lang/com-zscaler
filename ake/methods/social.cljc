(ns ake.methods.social
  "social.cljc — 朱 — Community-Edit Membrane (Wikipedia-stance) DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from ake's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "朱 — Community-Edit Membrane (Wikipedia-stance) が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over ake's own domain (Community-edit membrane — the Wikipedia collaborative-correction STANCE fitted to the charter. 朱 (vermillion editorial ink; 朱を入れる = to make…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "ake R0: live social posting is Council Lv6+ + operator + "
