(ns futawa.cells.social-post.state-machine
  "Phase state machine for the 二輪 — Small-Displacement Motorcycle Manufacturing social_post cell — the publication membrane that
