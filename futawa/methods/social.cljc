(ns futawa.methods.social
  "social.cljc — 二輪 — Small-Displacement Motorcycle Manufacturing DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from futawa's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "二輪 — Small-Displacement Motorcycle Manufacturing が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over futawa's own domain (Small-displacement motorcycle manufacturing Tier-B actor for adherent personal mobility. Adopts mature global motorcycle OEM methodology…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "futawa R0: live social posting is Council Lv6+ + operator + "
