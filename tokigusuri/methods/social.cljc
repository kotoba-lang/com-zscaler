(ns tokigusuri.methods.social
  "social.cljc — tokigusuri DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from tokigusuri's own
...
(defn draft-observation-post
  "A dry-run observation post over tokigusuri's own domain (Pharmaceutical patent-cliff / off-patent-access observatory — weaves drugs / exclusivity-barriers / patent-or-generic holders / bearers…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "tokigusuri R0: live social posting is Council Lv6+ + operator + "
