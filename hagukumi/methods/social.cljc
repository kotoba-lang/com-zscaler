(ns hagukumi.methods.social
  "social.cljc — 育み — Care DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from hagukumi's own
...
(defn draft-observation-post
  "A dry-run observation post over hagukumi's own domain (Daily-living care actor (childcare ages 2+ / eldercare / chronic-care continuity / meal delivery / respite support). Delivers L4 Care Tier…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "hagukumi R0: live social posting is Council Lv6+ + operator + "
