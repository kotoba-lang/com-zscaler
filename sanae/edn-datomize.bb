...
;; 同型 port は orgs/etzhayyim/com-etzhayyim-sanae/edn-datomize.bb (Phase 3) を参照。
;; schema-path はこのディレクトリ（20-actors/sanae/）直下（repo-root に manifest/ 規約が無いため）。
;;
;; 使い方:
...
(def root (str (io/file (System/getProperty "user.dir") "20-actors" "sanae")))
