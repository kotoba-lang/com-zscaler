(ns watatsumi.methods.social
  "social.cljc — 綿津見 — Civilian Submersible Manufacturing DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from watatsumi's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "綿津見 — Civilian Submersible Manufacturing が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over watatsumi's own domain (Civilian deep-sea submersible manufacturing Tier-B actor. Adopts modular ring-section construction methodology from mature European…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "watatsumi R0: live social posting is Council Lv6+ + operator + "
