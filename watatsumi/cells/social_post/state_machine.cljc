(ns watatsumi.cells.social-post.state-machine
  "Phase state machine for the 綿津見 — Civilian Submersible Manufacturing social_post cell — the publication membrane that
