(ns tsutae.methods.social
  "social.cljc — 伝え — Handheld Communication Device DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from tsutae's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "伝え — Handheld Communication Device が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over tsutae's own domain (Handheld communication device (smartphone-class consumer electronics) Tier-B actor. religious-corp first-party assembly + firmware for…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "tsutae R0: live social posting is Council Lv6+ + operator + "
