(ns noroshi.methods.social
  "social.cljc — noroshi DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from noroshi's own
...
(defn draft-observation-post
  "A dry-run observation post over noroshi's own domain (Photonics-electronics convergence (光電融合) communication-chip actor — the silicon-photonic / co-packaged-optics (CPO) sibling of the…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "noroshi R0: live social posting is Council Lv6+ + operator + "
