(ns tsubasa.methods.social
  "social.cljc — tsubasa DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from tsubasa's own
...
(defn draft-observation-post
  "A dry-run observation post over tsubasa's own domain (Skyscanner-inverse flight discovery commons — honest fare/route meta-search whose every onward link is AFFILIATE-STRIPPED and where the…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "tsubasa R0: live social posting is Council Lv6+ + operator + "
