(ns narashi.methods.social
  "social.cljc — 均 — Global Inequality Observation DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from narashi's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "均 — Global Inequality Observation が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over narashi's own domain (kotoba-native global economic inequality observation substrate. Ingests already-published World Bank WDI / UN SDG API / Our World in Data…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "narashi R0: live social posting is Council Lv6+ + operator + "
