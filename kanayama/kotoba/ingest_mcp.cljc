#!/usr/bin/env bb
;; kanayama 金山 — ingest seed.edn into a live kotoba node (cljc port of ingest_mcp.py).
;; ADR-2605252400.
(ns kanayama.kotoba.ingest-mcp
  "kanayama 金山 — MCP seed-ingest scaffold (dry-run default, live path placeholder).
  ADR-2605252400. Template: see funadaiku.kotoba.ingest-mcp."
  (:require [clojure.string :as str]
            #?(:clj [clojure.java.io :as io])))

(def default-url   "http://127.0.0.1:8077")
(def default-graph "com.etzhayyim.kanayama")
