(ns funadaiku.methods.social
  "social.cljc — 船大工 — Zero-Emission Autonomous Cargo Shipbuilding DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from funadaiku's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "船大工 — Zero-Emission Autonomous Cargo Shipbuilding が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over funadaiku's own domain (Zero-emission autonomous cargo shipbuilding — 9 Pregel cells implementing hull block fabrication, assembly, NDT inspection, powertrain…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "funadaiku R0: live social posting is Council Lv6+ + operator + "
