(ns funadaiku.cells.social-post.state-machine
  "Phase state machine for the 船大工 — Zero-Emission Autonomous Cargo Shipbuilding social_post cell — the publication membrane that
