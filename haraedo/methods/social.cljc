(ns haraedo.methods.social
  "social.cljc — haraedo DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from haraedo's own
...
(defn draft-observation-post
  "A dry-run observation post over haraedo's own domain (Global bulky-waste (粗大ゴミ) disposal — citizen intake (classify/quote/schedule/sticker) + operator logistics (受付/配車/ルート/担当者) + worldwide…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "haraedo R0: live social posting is Council Lv6+ + operator + "
