#!/usr/bin/env bb
;; haraedo 祓戸 — ingest seed.edn into a live kotoba node (cljc port of ingest_mcp.py).
;; ADR-2606010200.
(ns haraedo.kotoba.ingest-mcp
  "haraedo 祓戸 — MCP seed-ingest scaffold (dry-run default, live path placeholder).
  ADR-2606010200. Template: see funadaiku.kotoba.ingest-mcp."
  (:require [clojure.string :as str]
            #?(:clj [clojure.java.io :as io])))

(def default-url   "http://127.0.0.1:8077")
(def default-graph "com.etzhayyim.haraedo")
