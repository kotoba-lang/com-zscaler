(ns hokorobi.methods.social
  "social.cljc — hokorobi DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from hokorobi's own
...
(defn draft-observation-post
  "A dry-run observation post over hokorobi's own domain (World systemic finance-risk observatory — weaves financial institutions / risk-sources / bearers (insurance + banking-lending + pensions)…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "hokorobi R0: live social posting is Council Lv6+ + operator + "
