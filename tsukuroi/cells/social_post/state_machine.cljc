(ns tsukuroi.cells.social-post.state-machine
  "Phase state machine for the 繕い — Mend (authorized vulnerability remediation + patch proposal) social_post cell — the publication membrane that
