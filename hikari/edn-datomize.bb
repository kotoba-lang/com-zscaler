#!/usr/bin/env bb
;; 20-actors/hikari/edn-datomize.bb — EDN → Datomic/Datascript tx-data 変換ツール。
;; Ported/adapted from 20-actors/makura/edn-datomize.bb (same repo, Phase 4 fan-out,
;; itself adapted from manifest/edn-datomize.bb + the com-etzhayyim-futawa/mitsuho
;; copies used for the Phase 3 sibling-repo fanout). schema.edn accumulates at
;; 20-actors/hikari/schema.edn (there is no manifest/ dir at this level of
;; etzhayyim/root).
