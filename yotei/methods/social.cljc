(ns yotei.methods.social
  "social.cljc — yotei DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from yotei's own
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "yotei R0: live social posting is Council Lv6+ + operator + "
