(ns kokoro.methods.social
  "social.cljc — 心 — Mental Health Support DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from kokoro's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "心 — Mental Health Support が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over kokoro's own domain (Non-profit religious-corp mental health support substrate. Community + spiritual + relational framing (NOT clinical psychiatry). Peer…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "kokoro R0: live social posting is Council Lv6+ + operator + "
