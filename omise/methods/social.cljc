(ns omise.methods.social
  "social.cljc — omise DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from omise's own
...
(defn draft-observation-post
  "A dry-run observation post over omise's own domain (Shopify-inverse storefront commons — lets an etzhayyim producing-actor (yakushi/makura/mitsuho/sanae/…) or an SBT member stand up a…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "omise R0: live social posting is Council Lv6+ + operator + "
