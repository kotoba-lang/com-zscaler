(ns uchiwake.methods.social
  "social.cljc — 内訳 — World Product Bill-of-Materials / GTIN Knowledge Graph DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from uchiwake's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "内訳 — World Product Bill-of-Materials / GTIN Knowledge Graph が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over uchiwake's own domain (The product-level layer beneath kabuto 兜. Datafies the world's TRADE ITEMS keyed on the GS1 GTIN, decomposed to their bill of materials…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "uchiwake R0: live social posting is Council Lv6+ + operator + "
