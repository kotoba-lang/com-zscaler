(ns uchiwake.cells.social-post.state-machine
  "Phase state machine for the 内訳 — World Product Bill-of-Materials / GTIN Knowledge Graph social_post cell — the publication membrane that
