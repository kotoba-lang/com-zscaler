...
describe("Oil Midstream Actor Manifest", () => {
  ...
  it("cron report has 5 steps", () => {
    ...
    expect(cron.steps[2].id).toBe("networkConstraints");
  });
  ...
  it("xrpc covers pipeline, terminals, network, health", () => {
    ...
    expect(nsids).toContain("com.etzhayyim.apps.oilMidstream.infrastructure.getPipeline");
    expect(nsids).toContain("com.etzhayyim.apps.oilMidstream.infrastructure.listPipelines");
    expect(nsids).toContain("com.etzhayyim.apps.oilMidstream.infrastructure.listTerminals");
    expect(nsids).toContain("com.etzhayyim.apps.oilMidstream.infrastructure.getTerminalNetwork");
    expect(nsids).toContain("com.etzhayyim.apps.oilMidstream.health");
  });
