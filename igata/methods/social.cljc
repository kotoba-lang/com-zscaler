(ns igata.methods.social
  "social.cljc — 鋳型 — Megacasting / HPDC DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from igata's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "鋳型 — Megacasting / HPDC が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over igata's own domain (High-pressure die-casting (HPDC) / megacasting actor. religious-corp first-party large-aluminum-structure manufacturing supplier for…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "igata R0: live social posting is Council Lv6+ + operator + "
