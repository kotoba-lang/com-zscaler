(ns silicon.methods.social
  "social.cljc — silicon DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from silicon's own
...
(defn draft-observation-post
  "A dry-run observation post over silicon's own domain (First-party ternary silicon-fab orchestration — 8 fab 工程 (litho/deposition/etch/implant/CMP/metrology/test/packaging) の自社装置…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "silicon R0: live social posting is Council Lv6+ + operator + "
