(ns hotaru.methods.social
  "social.cljc — 蛍 — III-V / InP Substrate Open-Commons DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from hotaru's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "蛍 — III-V / InP Substrate Open-Commons が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over hotaru's own domain (Open-publication knowledge commons for III-V compound-semiconductor SUBSTRATE generation + manufacturing — indium phosphide (InP) first,…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "hotaru R0: live social posting is Council Lv6+ + operator + "
