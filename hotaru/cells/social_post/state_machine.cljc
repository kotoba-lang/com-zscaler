(ns hotaru.cells.social-post.state-machine
  "Phase state machine for the 蛍 — III-V / InP Substrate Open-Commons social_post cell — the publication membrane that
