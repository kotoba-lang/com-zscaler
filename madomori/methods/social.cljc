(ns madomori.methods.social
  "social.cljc — madomori DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from madomori's own
...
(defn draft-observation-post
  "A dry-run observation post over madomori's own domain (High-rise / façade window-cleaning robotics — the body for the HIGHEST unmet remote-work GAP named in ADR-2606073001 §4 ('高所・façade window…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "madomori R0: live social posting is Council Lv6+ + operator + "
