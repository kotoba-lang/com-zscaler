(ns saisei.methods.social
  "social.cljc — saisei DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from saisei's own
...
(defn draft-observation-post
  "A dry-run observation post over saisei's own domain (Citizen self-filing debt-relief CONCIERGE — the debtor-initiated counterpart to tate's creditor-side :insolvency track. A member who wants…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "saisei R0: live social posting is Council Lv6+ + operator + "
