(ns fuchi.cells.social-post.state-machine
  "Phase state machine for the 扶持 — Maintainer Sustenance Allocator (investment-fund inverse) social_post cell — the publication membrane that
