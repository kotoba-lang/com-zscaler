(ns business-manager.methods.social
  "social.cljc — business-manager DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from business-manager's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "business-manager が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over business-manager's own domain (Internal operational ERP (general ledger / AP / AR / procurement / budget / HR) for etzhayyim's own producing actors. Double-entry…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "business-manager R0: live social posting is Council Lv6+ + operator + "
