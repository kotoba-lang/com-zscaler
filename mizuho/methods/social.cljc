(ns mizuho.methods.social
  "social.cljc — 水穂 — Water + Sanitation DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from mizuho's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "水穂 — Water + Sanitation が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over mizuho's own domain (Non-profit religious-corp water + sanitation substrate. Community-scale only (NOT large municipal utility, N1). Upstream of mitsuho…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "mizuho R0: live social posting is Council Lv6+ + operator + "
