(ns kurashimori.methods.social
  "social.cljc — 暮らし守 — Citizen Consumer-Protection Concierge DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from kurashimori's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "暮らし守 — Citizen Consumer-Protection Concierge が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over kurashimori's own domain (kotoba-native citizen consumer-protection self-help concierge — the 国民生活センター / 消費生活センター-equivalent, citizen↔MERCHANT sibling of toritsugi…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "kurashimori R0: live social posting is Council Lv6+ + operator + "
