(ns kurashimori.cells.social-post.state-machine
  "Phase state machine for the 暮らし守 — Citizen Consumer-Protection Concierge social_post cell — the publication membrane that
