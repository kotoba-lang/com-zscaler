(ns utsushie.cells.social-post.state-machine
  "Phase state machine for the 写し絵 — News→Video Medium (kawaraban's projected-image sibling) social_post cell — the publication membrane that
