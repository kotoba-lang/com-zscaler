(ns shomei.cells.social-post.state-machine
  "Phase state machine for the 証明 — Believer Identity Binding + Proof-of-Personhood social_post cell — the publication membrane that
