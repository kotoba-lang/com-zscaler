(ns subaru.methods.social
  "social.cljc — subaru DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from subaru's own
...
(defn draft-observation-post
  "A dry-run observation post over subaru's own domain (Transparent connectivity-commons satellite constellation — the charter-clean inversion of Starlink/OneWeb. Connectivity delivered as §1.16…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "subaru R0: live social posting is Council Lv6+ + operator + "
