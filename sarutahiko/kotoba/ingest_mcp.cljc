#!/usr/bin/env bb
;; sarutahiko 猿田彦 — ingest seed.edn into a live kotoba node (cljc port of ingest_mcp.py).
;; ADR-2605252500.
(ns sarutahiko.kotoba.ingest-mcp
  "sarutahiko 猿田彦 — MCP seed-ingest scaffold (dry-run default, live path placeholder).
  ADR-2605252500. Template: see funadaiku.kotoba.ingest-mcp."
  (:require [clojure.string :as str]
            #?(:clj [clojure.java.io :as io])))

(def default-url   "http://127.0.0.1:8077")
(def default-graph "com.etzhayyim.sarutahiko")
