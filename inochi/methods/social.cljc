(ns inochi.methods.social
  "social.cljc — inochi DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from inochi's own
...
(defn draft-observation-post
  "A dry-run observation post over inochi's own domain (Living-world (生命圏) Knowledge Graph mirror — weaves species / ecosystems / biomes + the pressures borne by the living world into the kotoba…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "inochi R0: live social posting is Council Lv6+ + operator + "
