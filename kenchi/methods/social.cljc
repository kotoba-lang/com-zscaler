(ns kenchi.methods.social
  "social.cljc — 検地 — Worldwide Real-Estate Valuation (External-Market Transparency) DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from kenchi's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "検地 — Worldwide Real-Estate Valuation (External-Market Transparency) が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over kenchi's own domain (Public-good worldwide real-estate valuation + transparency substrate. Fuses many DISAGREEING independent authorities (recorded sales,…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "kenchi R0: live social posting is Council Lv6+ + operator + "
