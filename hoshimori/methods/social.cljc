(ns hoshimori.methods.social
  "social.cljc — hoshimori DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from hoshimori's own
...
(defn draft-observation-post
  "A dry-run observation post over hoshimori's own domain (Off-Earth / orbital (軌道) stewardship mirror — weaves orbital regimes / operators / hazards / services from PUBLIC catalogs into the kotoba…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "hoshimori R0: live social posting is Council Lv6+ + operator + "
