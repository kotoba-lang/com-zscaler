(ns infra-utility-connect.methods.social
  "social.cljc — infra-utility-connect DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from infra-utility-connect's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "infra-utility-connect が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over infra-utility-connect's own domain (Utility activation Tier-B actor — coordinates final connections (water, gas, electric, telecom) with service providers post-construction…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "infra-utility-connect R0: live social posting is Council Lv6+ + operator + "
