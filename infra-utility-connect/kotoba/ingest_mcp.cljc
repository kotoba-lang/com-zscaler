#!/usr/bin/env bb
;; infra-utility-connect インフラ接続 — ingest seed.edn into a live kotoba node (cljc port of ingest_mcp.py).
;; ADR-2605250900.
(ns infra-utility-connect.kotoba.ingest-mcp
  "infra-utility-connect インフラ接続 — MCP seed-ingest scaffold (dry-run default, live path placeholder).
  ADR-2605250900. Template: see funadaiku.kotoba.ingest-mcp."
  (:require [clojure.string :as str]
            #?(:clj [clojure.java.io :as io])))

(def default-url   "http://127.0.0.1:8077")
(def default-graph "com.etzhayyim.infrautilityconnect")
