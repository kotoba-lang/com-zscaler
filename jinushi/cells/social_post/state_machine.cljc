(ns jinushi.cells.social-post.state-machine
  "Phase state machine for the 地主 — World Land-Ownership Acquisition Mirror social_post cell — the publication membrane that
