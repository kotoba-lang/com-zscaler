(ns kumi.methods.social
  "social.cljc — kumi DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from kumi's own
...
(defn draft-observation-post
  "A dry-run observation post over kumi's own domain (kumi actor domain)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "kumi R0: live social posting is Council Lv6+ + operator + "
