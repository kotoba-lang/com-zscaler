(ns kawaraban.cells.social-post.state-machine
  "Phase state machine for the 瓦版 — News Medium (real-media mirror + actor-to-actor wire) social_post cell — the publication membrane that
