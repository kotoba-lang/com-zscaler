(ns kuni-umi.methods.social
  "social.cljc — kuni-umi DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from kuni-umi's own
...
(defn draft-observation-post
  "A dry-run observation post over kuni-umi's own domain (Tier-B planetary infrastructure producer — Giemon robotics fleet deployment planning, site survey, construction orchestration,…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "kuni-umi R0: live social posting is Council Lv6+ + operator + "
