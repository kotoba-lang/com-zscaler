(ns mimamori.methods.social
  "social.cljc — mimamori DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from mimamori's own
...
(defn draft-observation-post
  "A dry-run observation post over mimamori's own domain (Covenant keeping membrane (相互保持者会) — the substrate for bonds of keeping (offer / consent / content-free heartbeat / consented care-routing…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "mimamori R0: live social posting is Council Lv6+ + operator + "
