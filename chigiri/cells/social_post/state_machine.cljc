(ns chigiri.cells.social-post.state-machine
  "Phase state machine for the 契 — Covenant (legal procedure substrate) social_post cell — the publication membrane that
