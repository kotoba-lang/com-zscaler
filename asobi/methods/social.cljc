(ns asobi.methods.social
  "social.cljc — asobi DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from asobi's own
...
(defn draft-observation-post
  "A dry-run observation post over asobi's own domain (Freed-time / play & cultural-expression (遊び) KG mirror — weaves cultural works / events / venues / practices + the enclosures that gate…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "asobi R0: live social posting is Council Lv6+ + operator + "
