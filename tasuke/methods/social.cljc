(ns tasuke.methods.social
  "social.cljc — 助 — Free Cybercrime-Victim-Support Membrane DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from tasuke's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "助 — Free Cybercrime-Victim-Support Membrane が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over tasuke's own domain (Free cybercrime-victim-support membrane. 助 (たすけ) is where a consenting member who has been hit by online crime — phishing / 不正送金 /…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "tasuke R0: live social posting is Council Lv6+ + operator + "
